...
//	本例程给LTDC划分的显存为每层 480*272*4*3 字节，预留了32位色开双层显示以及使用三缓冲的空间，
//	用户可根据自己的实际应用进行调整,在 lcd_rgb.h 和 GUIConf.c 里进行配置
//
//extern uint32_t LCD_LAYER0_FRAME_BUFFER;									
//extern uint32_t LCD_LAYER1_FRAME_BUFFER;
