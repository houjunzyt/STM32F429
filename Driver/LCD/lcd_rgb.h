...
#define 	LCD_CLK  		 9		//定义LCD驱动时钟，这里为了方便计算数值应在3-18之间，单位为M
...
//#define LCD_MemoryAdd   0xD0000000 	//显存的起始地址  
	...
	#define LCD_Buffer_Size  LCD_MemoryAdd_OFFSET+LCD_Pixels * BytesPerPixel_1
#else
	#define LCD_Buffer	LCD_MemoryAdd + LCD_Pixels * BytesPerPixel_0	//只开单层时，缓冲层的起始地址
	#define LCD_Buffer_Size  LCD_MemoryAdd_OFFSET
#endif
